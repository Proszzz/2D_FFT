...
#
# Generated by Vivado on Thu Apr 24 12:46:30 +0800 2025
...
simulate()
{
  xsim xfft_1 -key {Behavioral:sim_1:Functional:xfft_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c657.protoinst" -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
