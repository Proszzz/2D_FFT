...
#
# Generated by Vivado on Thu Apr 24 12:45:27 +0800 2025
...
simulate()
{
  xsim xfft_0 -key {Behavioral:sim_1:Functional:xfft_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c657.protoinst" -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
