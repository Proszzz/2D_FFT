...
HD_PWD='C:/Users/dell/Desktop/Tensor/2D_FFT_0_final/dma_test.runs/top_axis_data_fifo_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_axis_data_fifo_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_axis_data_fifo_0_1.tcl
